...
```{r}
# # save trace plots to file
# diagnostics(nma_res)

# # save lots of other plots to file
# nma_outputs(nma_res, nma_model)
```
...
Its also possible to run all of the BUGS and output plots and table functions together and dump to file.
