---
title: "Run multiple NMA"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{run_multiple_nma}
...
This document describes how to use the main functions of `NMA` to run multiple network meta-analysis at once.
